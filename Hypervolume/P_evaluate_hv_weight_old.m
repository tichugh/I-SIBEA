function Metric = P_evaluate_hv_weight(Operation,FunctionValue,RefPoint,W)
...
%                 save('S')
        ...
        case 'nHV'
            ...
            Metric = P_evaluate_hv_weight('HV',FunctionValue,RefPoint,W)/abs(prod(max(RefPoint,[],1)));
    end
end
